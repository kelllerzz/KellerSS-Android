...
function keller_banner(){
  echo "\e[37m
           KellerSS Android\e[36m Fucking Cheaters\e[91m\e[37m discord.gg/allianceoficial\e[91m
                    ...
                    \e[36m{C} Coded By - KellerSS | Credits for Sheik Sheik meu piru                                
\e[32m
  \n";
}
...
function atualizar()
{
    ...
    echo "{$verde}[✓] Verificação concluída com sucesso.
";
...
";
            ...
            if ($logcatOutput !== null && trim($logcatOutput) !== "") {
                ...
                echo "{$verde}[✓] Nenhum problema detectado.
";
            }
